...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'inbound_id', type: 'integer', example: 1),
        new OA\Property(property: 'item_id', type: 'integer', example: 10),
        new OA\Property(property: 'expected_qty', type: 'integer', example: 50),
...
class InboundController extends Controller
{
    ...
    #[OA\Post(
        ...
        parameters: [
            new OA\Parameter(name: 'id', in: 'path', required: true, description: 'Inbound ID', schema: new OA\Schema(type: 'integer'))
        ],
    ...
    public function assign(int $id, AssignInboundRequest $request): JsonResponse
    {
        try {
