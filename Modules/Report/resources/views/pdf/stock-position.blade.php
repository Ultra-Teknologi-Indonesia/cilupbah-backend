...
<head>
    ...
    <style>
        ...
        body { font-family: DejaVu Sans, sans-serif; color: #1f2937; font-size: 6px; }
        ...
        th, td { border: 0.5px solid #cbd5e1; padding: 3px 2px; vertical-align: top; word-wrap: break-word; }
        th:nth-child(-n+4), td:nth-child(-n+4) { text-align: left; }
        th:not(:nth-child(-n+4)), td:not(:nth-child(-n+4)) { text-align: right; }
