...
final class DisputeOutcomeNormalizer
{
    private const SHOPEE = [
        ...
        'SELLER_DISPUTE'      => DisputeOutcome::PENDING,
    ...
    private const TIKTOK = [
        ...
        'REFUNDED'            => DisputeOutcome::REFUNDED,
        'RETURN_OR_REFUND_REQUEST_COMPLETE' => DisputeOutcome::REFUNDED,
        'REFUND_SUCCESS'      => DisputeOutcome::REFUNDED,
        'REQUEST_SUCCESS'     => DisputeOutcome::BUYER_WIN,
        'AWAITING_BUYER_SHIP' => DisputeOutcome::BUYER_WIN,
        'BUYER_SHIPPED_ITEM'  => DisputeOutcome::BUYER_WIN,
        'RETURN_OR_REFUND_REQUEST_PENDING' => DisputeOutcome::PENDING,
        'RETURN_OR_REFUND_REQUEST_CANCEL' => DisputeOutcome::CANCELLED,
        'RETURN_OR_REFUND_CANCEL' => DisputeOutcome::CANCELLED,
        'REPLACEMENT_REQUEST_CANCEL' => DisputeOutcome::CANCELLED,
        'REQUEST_REJECTED'    => DisputeOutcome::SELLER_WIN,
        'RETURN_OR_REFUND_REQUEST_REJECT' => DisputeOutcome::SELLER_WIN,
        'REFUND_OR_RETURN_REQUEST_REJECT' => DisputeOutcome::SELLER_WIN,
        'RECEIVE_REJECTED'    => DisputeOutcome::SELLER_WIN,
        'REJECT_RECEIVE_PACKAGE' => DisputeOutcome::SELLER_WIN,
        'REPLACEMENT_REQUEST_REJECT' => DisputeOutcome::SELLER_WIN,
    ];
