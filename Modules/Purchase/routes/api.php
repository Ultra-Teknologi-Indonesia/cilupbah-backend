...
Route::middleware(['auth:sanctum'])->prefix('v1')->group(function () {
    ...
    // ─── Purchase Return Settlements (§10d — sub-resources first) ───
    ...
    // ─── Purchase Returns (§10d — literal routes first) ───
    ...
    // ─── Purchase Bills (§10b — literal routes first) ───
    ...
    // ─── Purchase Orders (§10a — literal routes first, wildcard last) ───
