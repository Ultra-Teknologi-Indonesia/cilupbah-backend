...
class PickingConcurrencyTest extends TestCase
{
    ...
    public function test_concurrent_delta_picks_accumulate_and_do_not_lose_updates(): void
    {
        ...
        $this->assertSame(3, $this->onHand($s['item_variant_id']), 'on_hand harus langsung berkurang sesuai qty picking.');
    ...
    public function test_negative_correction_returns_stock_and_lowers_qty_picked(): void
    {
        ...
        $this->assertSame(8, $this->onHand($s['item_variant_id']), 'Koreksi picking harus mengembalikan stok fisik sesuai qty yang dibatalkan.');
    }
