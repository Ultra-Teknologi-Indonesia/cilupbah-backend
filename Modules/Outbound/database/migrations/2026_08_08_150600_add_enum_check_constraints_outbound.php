...
return new class extends Migration
{
    ...
    private array $checks = [
        ['picklist_items', 'item_status', ['PENDING', 'PARTIAL', 'COMPLETED', 'SHORT', 'REJECTED']],
        ['shipments', 'driver_call_method', ['MANUAL', 'SHOPEE_AUTO', 'SHOPEE_INSTANT', 'TIKTOK_INSTANT', 'LAZADA_INSTANT']],
        ['shipments', 'driver_call_status', ['NONE', 'CALLED', 'PICKED_UP', 'FAILED']],
    ];
