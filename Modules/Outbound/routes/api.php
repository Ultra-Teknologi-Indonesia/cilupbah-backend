...
Route::middleware(['auth:sanctum'])->prefix('v1/outbound')->group(function () {
    ...
    Route::get('pickers', [OutboundFulfillmentController::class, 'pickers'])->name('outbound.pickers.index')->middleware('role_or_permission:owner|view-picking|view-packing|packer|picker');
