...
class MonitorLiveQueueCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        do {
            ...
            $stats = Cache::remember('channel_monitor:inbox_status_counts', 5, fn () => DB::table('channel_webhook_inbox')
            ...
            $last1Min = Cache::remember('channel_monitor:processed_last_minute', 5, fn () => DB::table('channel_webhook_inbox')
            ...
            $latestOrders = Cache::remember('channel_monitor:latest_orders', 5, fn () => DB::table('sales_orders')
