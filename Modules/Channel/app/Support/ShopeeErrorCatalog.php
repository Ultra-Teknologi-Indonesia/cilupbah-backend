...
class ShopeeErrorCatalog
{
    ...
    protected const MAP = [
        ...
        'error_invalid_item_list' => [self::USER_FIXABLE, 'Daftar produk untuk dinaikkan tidak valid. Sinkronkan produk lalu coba lagi.'],
        'error_get_parnter_token_failed' => [self::RETRYABLE, 'Gagal terhubung ke Shopee. Coba lagi.'],
        'error_inner' => [self::RETRYABLE, 'Shopee sedang mengalami gangguan. Coba lagi nanti.'],
