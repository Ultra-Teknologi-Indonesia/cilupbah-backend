...
class ChannelShop extends Model
{
    ...
    protected $casts = [
        ...
        'fulfillment_handover_at' => 'datetime',
        ...
        'order_pull_window_from' => 'datetime',
        'order_pull_window_to' => 'datetime',
        'order_pull_attempts' => 'integer',
        'order_pull_next_attempt_at' => 'datetime',
