...
class UpdateChannelShopRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price_push_enabled' => 'sometimes|boolean',
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            $fields = ['is_active', 'order_sync_enabled', 'is_shadow_mode', 'catalog_pull_enabled', 'catalog_push_enabled', 'stock_push_enabled', 'price_push_enabled', 'fulfillment_push_enabled', 'handover_method', 'stock_source_mode', 'location_id'];
