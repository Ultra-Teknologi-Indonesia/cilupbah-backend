    ...
    'groups' => [
        ...
        [
            ...
            'resources' => [
                ...
                ['key' => 'monitor-stok', 'label' => 'Monitor Stok', 'actions' => ['view', 'edit', 'export']],
        ...
        [
            ...
            'resources' => [
                ...
                ['key' => 'pembayaran-penjualan', 'label' => 'Pembayaran & Settlement Penjualan', 'actions' => ['view', 'create', 'edit', 'delete']],
        ...
        [
            ...
            'label' => 'Gudang',
            'resources' => [
                ['key' => 'barang-masuk', 'label' => 'Barang Masuk (Inbound)', 'actions' => ['view', 'create', 'edit', 'delete', 'export']],
                ['key' => 'penempatan', 'label' => 'Penempatan (Putaway)', 'actions' => ['view', 'create', 'edit', 'delete', 'export']],
                ['key' => 'barang-keluar', 'label' => 'Barang Keluar (Transfer)', 'actions' => ['view', 'create', 'edit', 'delete', 'export']],
                ['key' => 'picking', 'label' => 'Picking', 'actions' => ['view', 'create', 'edit', 'delete', 'export']],
                ['key' => 'packing', 'label' => 'Packing', 'actions' => ['view', 'create', 'edit', 'delete']],
                ['key' => 'pengiriman', 'label' => 'Pengiriman & Serah Terima', 'actions' => ['view', 'create', 'edit', 'delete', 'export']],
