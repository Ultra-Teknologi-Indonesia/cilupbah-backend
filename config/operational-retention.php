...
return [
    ...
    'max_rows_per_resource' => max(100, (int) env('OPERATIONAL_RETENTION_MAX_ROWS_PER_RESOURCE', 10000)),

    'failed_jobs_hours' => max(1, (int) env('FAILED_JOBS_RETENTION_HOURS', 24 * 14)),
    'queue_failure_attempts_hours' => max(1, (int) env('QUEUE_FAILURE_ATTEMPTS_RETENTION_HOURS', 24 * 14)),
