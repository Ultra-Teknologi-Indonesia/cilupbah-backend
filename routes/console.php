...
Schedule::command('channel:reap-stock-outbox-leases')->everyMinute()->withoutOverlapping(1)->onOneServer();
Schedule::command('channel:dispatch-stock-outbox')->everyMinute()->withoutOverlapping(2)->onOneServer();
