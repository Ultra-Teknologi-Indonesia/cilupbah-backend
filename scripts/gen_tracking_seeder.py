...
"GET /inventory/internal-price-list/":"todo","GET /inventory/item-bundles/":"done","DELETE /inventory/items/":"done","GET /inventory/items/":"done","POST /inventory/items/":"done","POST /inventory/items/all-stocks/":"done","POST /inventory/items/archive/":"done","GET /inventory/items/archived/":"done","GET /inventory/items/by-sku/{sku}":"done","GET /inventory/items/channel-category-attributes/":"done","GET /inventory/items/channel-category-tree/":"done","GET /inventory/items/group/{id}":"done","DELETE /inventory/items/item-variant/":"todo","GET /inventory/items/masters":"done","POST /inventory/items/prices/":"done","POST /inventory/items/restore/":"done","GET /inventory/items/reviews/":"done","GET /inventory/items/{id}":"done",
